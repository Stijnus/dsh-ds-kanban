	...
	factory: (require) => {
		...
		*/
		...
		function isAttention(card, contextWarningPercent) {
			return card.column === "waiting" || card.column === "blocked" || (card.contextPercent ?? 0) >= contextWarningPercent;
		}
		/**
		...
		*/
		function dropColumn(id, column, cards) {
			...
			if (card !== void 0 && !card.blank) return void 0;
			return column;
		}
		...
		*/
		...
		function TaskCard({ card, settings, props }) {
			const { t } = props;
			...
			const onKeyDown = (event) => {
				...
				document.querySelector(`[data-card-column="${next}"]`)?.focus();
			};
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							card.waiting && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("waitingIndicator") }),
							card.failure !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("failedIndicator") }),
		...
		function BoardColumnView({ column, cards, settings, props }) {
		...
		function KanbanBoard(props) {
			...
			const statButton = (label, value, status) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				type: "button",
			...
			const reconcile = (list) => {
				...
				for (const id of list.ids) {
					...
					subscriptions.set(id, {
						face,
						dispose: face.subscribe(publish)
					});
				}
				publish();
			};
