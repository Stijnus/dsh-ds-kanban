window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function AgentList({ parentId, props, ancestors }) {
			...
			}, [parentId, setSubagentCatalogOpen]);
					...
					catalog?.entries.map((entry) => {
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								entry.hasChildren && !ancestors.includes(entry.id) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									"aria-expanded": open,
									onClick: () => {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: t(agentsOpen ? "agents.hide" : "agents.show")
						}), agentsOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AgentList, {
							parentId: card.id,
							props,
							ancestors: [card.id]
						})]
